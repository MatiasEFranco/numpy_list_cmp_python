...
if __name__ == '__main__':
    ...
    list_numeros_str = ['5', '-2', '3', '', '17', 'NaN']
    list_numeros = [x if x.isdigit() is True else 0 for x in list_numeros_str]
    print( list_numeros)

    # ¿Ya terminaron el ejercicio? ¿Por qué no prueban
    # hacer negativo alguno de los números de la lista?
    # ¿Qué sucede con isdigit? Sorprendente no? rep: unicamente toma los valores positivos 
